...
LDFLAGS_STATIC = -DNDEBUG $(LDFLAGS_STATIC_2) -fsanitize=address -lasan # FLAGS ADDED HERE
...
CFLAGS = -fsanitize=address -lasan $(MY_ARCH_2) $(LOCAL_FLAGS) $(CFLAGS_BASE2) $(CFLAGS_BASE) $(CC_SHARED) -o $@ # FLAGS ADDED HERE
...
CXXFLAGS = -fsanitize=address -lasan $(MY_ARCH_2) $(LOCAL_FLAGS) $(CXXFLAGS_BASE2) $(CFLAGS_BASE) $(CXXFLAGS_EXTRA) $(CC_SHARED) -o $@ $(CXX_WARN_FLAGS) # FLAGS ADDED HERE
