...
ifdef IS_MINGW
LDFLAGS_STATIC_2 = -static -fsanitize=undefined -lasan # FLAGS ADDED HERE
else
ifndef DEF_FILE
...
LDFLAGS_STATIC = -DNDEBUG $(LDFLAGS_STATIC_2) -fsanitize=undefined -lasan # FLAGS ADDED HERE
...
CFLAGS = -fsanitize=undefined -lasan $(MY_ARCH_2) $(LOCAL_FLAGS) $(CFLAGS_BASE2) $(CFLAGS_BASE) $(CC_SHARED) -o $@ # FLAGS ADDED HERE
...
CXXFLAGS = -fsanitize=undefined -lasan $(MY_ARCH_2) $(LOCAL_FLAGS) $(CXXFLAGS_BASE2) $(CFLAGS_BASE) $(CXXFLAGS_EXTRA) $(CC_SHARED) -o $@ $(CXX_WARN_FLAGS) # FLAGS ADDED HERE
