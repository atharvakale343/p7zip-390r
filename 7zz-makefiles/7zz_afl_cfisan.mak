...
ifdef IS_MINGW
LDFLAGS_STATIC_2 = -static -fsanitize=cfi -fno-sanitize=cfi-nvcall,cfi-icall -flto -fvisibility=hidden -lasan # FLAGS ADDED HERE
else
ifndef DEF_FILE
...
LDFLAGS_STATIC = -DNDEBUG $(LDFLAGS_STATIC_2) -fsanitize=cfi -fno-sanitize=cfi-nvcall,cfi-icall -flto -fvisibility=hidden -lasan # FLAGS ADDED HERE
...
CFLAGS = -fsanitize=cfi -fno-sanitize=cfi-nvcall,cfi-icall -flto -fvisibility=hidden -lasan $(MY_ARCH_2) $(LOCAL_FLAGS) $(CFLAGS_BASE2) $(CFLAGS_BASE) $(CC_SHARED) -o $@ # FLAGS ADDED HERE
...
CXXFLAGS = -fsanitize=cfi -fno-sanitize=cfi-nvcall,cfi-icall -flto -fvisibility=hidden -lasan $(MY_ARCH_2) $(LOCAL_FLAGS) $(CXXFLAGS_BASE2) $(CFLAGS_BASE) $(CXXFLAGS_EXTRA) $(CC_SHARED) -o $@ $(CXX_WARN_FLAGS) # FLAGS ADDED HERE
