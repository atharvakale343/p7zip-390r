...
ifdef IS_MINGW
LDFLAGS_STATIC_2 = -static -fsanitize=address -lasan # FLAGS ADDED HERE
else
ifndef DEF_FILE
ifndef IS_NOT_STANDALONE
ifndef MY_DYNAMIC_LINK
ifneq ($(CC), clang)
LDFLAGS_STATIC_2 = -g2 -O0
# -static
...
LDFLAGS_STATIC = -DNDEBUG $(LDFLAGS_STATIC_2) -fsanitize=address -lasan -g2 -O0 # FLAGS ADDED HERE
...
CFLAGS = -fsanitize=address -lasan $(MY_ARCH_2) $(LOCAL_FLAGS) $(CFLAGS_BASE2) $(CFLAGS_BASE) $(CC_SHARED) -g2 -O0 -o $@
...
$O/libzstd.$(DYSUFFIX): ../../../../C/zstd/lib/zstd.h
	...
	$(CD) zstd_build; \
	cmake ../../../../../C/zstd/build/cmake -DCMAKE_C_FLAGS="-g2 -O0" -DCMAKE_BUILD_TYPE=Debug -DZSTD_BUILD_PROGRAMS=OFF -DZSTD_BUILD_STATIC=OFF -DCMAKE_C_COMPILER=$(CC) -DCMAKE_CXX_COMPILER=$(CXX); \
	$(MAKE) -j; \
	$(CD) ../; \
...
$O/liblz4.$(DYSUFFIX): ../../../../C/lz4/lib/lz4.h
	...
	$(CD) lz4_build; \
	cmake -DCMAKE_C_FLAGS="-g2 -O0" -DCMAKE_BUILD_TYPE=Debug ../../../../../C/lz4/build/cmake -DCMAKE_C_FLAGS="-g2 -O0" -DCMAKE_BUILD_TYPE=Debug -DLZ4_BUILD_CLI=OFF -DLZ4_BUILD_LEGACY_LZ4C=OFF -DCMAKE_C_COMPILER=$(CC) -DCMAKE_CXX_COMPILER=$(CXX); \
	$(MAKE) -j; \
	$(CD) ../; \
...
$O/libbrotlicommon.$(DYSUFFIX) $O/libbrotlienc.$(DYSUFFIX) $O/libbrotlidec.$(DYSUFFIX): ../../../../C/brotli/c/include/brotli/decode.h
	...
	$(CD) brotli_build; \
	cmake -DCMAKE_BUILD_TYPE=Debug -DCMAKE_C_FLAGS="-g2 -O0" ../../../../../C/brotli/ -DCMAKE_BUILD_TYPE=Debug -DCMAKE_C_FLAGS="-g2 -O0" -DBUILD_TESTING=OFF -DCMAKE_C_COMPILER=$(CC) -DCMAKE_CXX_COMPILER=$(CXX); \
	$(MAKE) -j; \
	$(CD) ../; \
...
$O/liblzhamdll.$(DYSUFFIX) $O/liblzhamcomp.$(DYSUFFIX) $O/liblzhamdecomp.$(DYSUFFIX): ../../../../C/lzham_codec/lzhamdll/lzham_api.cpp
	...
	$(CD) lzham_build; \
	cmake -DCMAKE_C_FLAGS="-g2 -O0" ../../../../../C/lzham_codec/ -DCMAKE_BUILD_TYPE=Debug -DCMAKE_C_FLAGS="-g2 -O0" -DCMAKE_C_COMPILER=$(CC) -DCMAKE_CXX_COMPILER=$(CXX); \
	$(MAKE) -j; \
	$(CD) ../; \
